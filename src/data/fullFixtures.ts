...
function buildComprehensiveBulten(): Match[] {
  ...
  list.push(
    createMatch({ id: 'tr-sl-1', sport: 'FOOTBALL', leagueId: 'tr-superlig', leagueName: 'Trendyol Süper Lig', leagueLogo: '🇹🇷', country: 'Türkiye', tvChannel: 'beIN Sports 1 HD', hName: 'Galatasaray', hShort: 'GS', hLogo: '🦁', aName: 'Fenerbahçe', aShort: 'FB', aLogo: '🟡🔵', time: '20:00', ms1: 2.15, msX: 3.40, ms2: 3.10, stadium: 'RAMS Park', referee: 'Halil Umut Meler', hot: true, ai: true }),
    createMatch({ id: 'tr-sl-2', sport: 'FOOTBALL', leagueId: 'tr-superlig', leagueName: 'Trendyol Süper Lig', leagueLogo: '🇹🇷', country: 'Türkiye', tvChannel: 'beIN Sports 1 HD', hName: 'Beşiktaş', hShort: 'BJK', hLogo: '🦅', aName: 'Trabzonspor', aShort: 'TS', aLogo: '🔴🔵', time: '20:30', ms1: 1.95, msX: 3.45, ms2: 3.60, stadium: 'Tüpraş Stadyumu', referee: 'Ali Şansalan', hot: true, ai: true }),
    createMatch({ id: 'tr-sl-3', sport: 'FOOTBALL', leagueId: 'tr-superlig', leagueName: 'Trendyol Süper Lig', leagueLogo: '🇹🇷', country: 'Türkiye', tvChannel: 'beIN Sports 2 HD', hName: 'Başakşehir', hShort: 'İBFK', hLogo: '🟠🔵', aName: 'Samsunspor', aShort: 'SAM', aLogo: '🔴⚪', time: '19:00', ms1: 2.10, msX: 3.30, ms2: 3.25, stadium: 'Fatih Terim Stadı' }),
    createMatch({ id: 'tr-sl-4', sport: 'FOOTBALL', leagueId: 'tr-superlig', leagueName: 'Trendyol Süper Lig', leagueLogo: '🇹🇷', country: 'Türkiye', tvChannel: 'beIN Sports 2 HD', hName: 'Eyüpspor', hShort: 'EYP', hLogo: '🟣🟡', aName: 'Göztepe', aShort: 'GÖZ', aLogo: '🟡🔴', time: '16:00', ms1: 2.25, msX: 3.20, ms2: 3.00 }),
  ...
  list.push(
    createMatch({ id: 'eng-pl-1', sport: 'FOOTBALL', leagueId: 'eng-premier', leagueName: 'Premier League', leagueLogo: '🏴󠁧󠁢󠁥󠁮󠁧󠁿', country: 'İngiltere', tvChannel: 'beIN Sports 3', hName: 'Manchester City', hShort: 'MCI', hLogo: '🩵', aName: 'Liverpool', aShort: 'LIV', aLogo: '🔴', time: '18:30', ms1: 2.05, msX: 3.65, ms2: 3.35, hot: true, ai: true }),
  ...
  list.push(
    ...
    createMatch({ id: 'ita-sa-5', sport: 'FOOTBALL', leagueId: 'ita-seriea', leagueName: 'Serie A', leagueLogo: '🇮🇹', country: 'İtalya', tvChannel: 'S Sport 2', hName: 'Bologna', hShort: 'BOL', hLogo: '🔴🔵', aName: 'Torino', aShort: 'TOR', aLogo: '🐂', time: '16:00', ms1: 2.10, msX: 3.15, ms2: 3.55 }),
  ...
  list.push(
    ...
    createMatch({ id: 'fra-l1-6', sport: 'FOOTBALL', leagueId: 'fra-ligue1', leagueName: 'Fransa Ligue 1', leagueLogo: '🇫🇷', country: 'Fransa', tvChannel: 'beIN Sports MAX 2', hName: 'Strasbourg', hShort: 'RCSA', hLogo: '🔵⚪', aName: 'Reims', aShort: 'SDR', aLogo: '🔴⚪', time: '18:00', ms1: 2.30, msX: 3.25, ms2: 2.95 }),
  ...
  list.push(
    // EuroLeague
    createMatch({ id: 'bb-el-1', sport: 'BASKETBALL', leagueId: 'euroleague', leagueName: 'EuroLeague', leagueLogo: '🏀', country: 'Avrupa', tvChannel: 'S Sport / EuroLeague TV', hName: 'Fenerbahçe Beko', hShort: 'FBB', hLogo: '🟡🔵', aName: 'Panathinaikos AKTOR', aShort: 'PAO', aLogo: '🟢⚪', time: '20:45', ms1: 1.75, ms2: 2.05, totalPointsLine: 165.5, overTotalPoints: 1.85, underTotalPoints: 1.85, handicapHome: -3.5, hot: true, ai: true }),
  ...
  list.push(
    createMatch({ id: 'vb-sult-1', sport: 'VOLLEYBALL', leagueId: 'tr-sultanlar', leagueName: 'Vodafone Sultanlar Ligi', leagueLogo: '🏐', country: 'Türkiye', tvChannel: 'TRT Spor Yıldız', hName: 'Fenerbahçe Medicana', hShort: 'FBM', hLogo: '🟡🔵', aName: 'VakıfBank', aShort: 'VAK', aLogo: '🟡⬛', time: '19:30', ms1: 1.70, ms2: 2.10, totalPointsLine: 184.5, overTotalPoints: 1.85, underTotalPoints: 1.85, hot: true, ai: true }),
  ...
  list.push(
    createMatch({ id: 'tn-atp-1', sport: 'TENNIS', leagueId: 'atp-tour', leagueName: 'ATP Dünya Turu Masters', leagueLogo: '🎾', country: 'Uluslararası', tvChannel: 'Eurosport 1 HD', hName: 'Novak Djokovic', hShort: 'DJO', hLogo: '🎾', aName: 'Carlos Alcaraz', aShort: 'ALC', aLogo: '🎾', time: '21:00', ms1: 2.15, ms2: 1.70, totalPointsLine: 23.5, overTotalPoints: 1.85, underTotalPoints: 1.85, hot: true, ai: true }),
    ...
    createMatch({ id: 'tn-wta-4', sport: 'TENNIS', leagueId: 'wta-tour', leagueName: 'WTA Dünya Turu', leagueLogo: '🎾', country: 'Uluslararası', tvChannel: 'beIN Sports MAX 2', hName: 'Jasmine Paolini', hShort: 'PAO', hLogo: '🎾', aName: 'Mirra Andreeva', aShort: 'AND', aLogo: '🎾', time: '14:30', ms1: 1.85, ms2: 1.95, totalPointsLine: 21.5, overTotalPoints: 1.85, underTotalPoints: 1.85 }),
